...
示例:
- python run_weather.py --scan       # 扫描市场 + 生成信号（dry-run）
- python run_weather.py --positions  # 查看余额 / 持仓 / 挂单
- python run_weather.py --live       # 实盘扫描 + 下单
"""
...
async def amain() -> int:
    parser = argparse.ArgumentParser(description="Polymarket weather bot CLI")
